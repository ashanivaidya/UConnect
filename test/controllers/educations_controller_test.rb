...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { college_name: @education.college_name, degree: @education.degree, gpa: @education.gpa }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: { college_name: @education.college_name, degree: @education.degree, gpa: @education.gpa }
    assert_redirected_to education_path(assigns(:education))
  end
