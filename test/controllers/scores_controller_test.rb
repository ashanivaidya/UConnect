...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { act: @score.act, gre: @score.gre, ielts: @score.ielts, sat: @score.sat, toefl: @score.toefl }
    end
  ...
  test "should update score" do
    patch :update, id: @score, score: { act: @score.act, gre: @score.gre, ielts: @score.ielts, sat: @score.sat, toefl: @score.toefl }
    assert_redirected_to score_path(assigns(:score))
  end
